  ...
  <div class="cta-inner">
    ...
    <div id="ctaFormWrap" class="reveal reveal-delay-3">
      <form class="cta-form" id="ctaForm" onsubmit="handleCtaSubmit(event)">
        ...
        <div class="cta-privacy">No credit card required. No spam. We will contact you when matchMor launches in your area. Your information is never sold or shared. <a href="/api/privacy.html" style="color:var(--gold);text-decoration:none">Privacy Policy</a></div>
      </form>
    </div>
...
<footer>
  ...
  <div class="footer-links">
    ...
    <a href="/api/privacy.html" class="footer-link">Privacy Policy</a>
    <a href="/api/terms.html" class="footer-link">Terms</a>
